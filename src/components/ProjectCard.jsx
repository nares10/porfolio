...
export default function ProjectCard({ project }) {
  ...
  return (
    <article ref={ref} className={`border border-black/10 p-4 rounded-md bg-white transition-transform duration-150 hover:-translate-y-1 hover:shadow-sm ${inView ? 'animate-fade-up' : 'opacity-0'}`}>
